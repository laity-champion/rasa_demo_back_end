...
def check():
    ...
    with open(r'Medical_Spider_API/QA/question.txt', 'w', encoding='unicode_escape') as f:
        f.write(questions)
    spider_name = "docter"
    subprocess.check_output(['scrapy', 'crawl', spider_name])
    with open(r'Medical_Spider_API/QA/Answer.txt', 'r', encoding='unicode_escape') as fr:
        answer = fr.read()
    dict = {'1': answer}
...
if __name__ == "__main__":
    ...
    app.run('192.168.0.108', port=8888, debug=True)
